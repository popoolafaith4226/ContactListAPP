...
from ActionPages.action_pages import LoginPages, SignupButton, FirstName, LastName, Email, Password, SubmitButton, \
    AddContactButton, AddContactFirstName, AddContactLastName, AddContactDOB, AddContactEmail, \
    AddContactPhone, AddContactAddress1, AddContactCity, AddContactState, AddContactCountry, CLickSubmitButton, \
    AddContactAddress2, AddContactPostalCode, LogOutButton
...
def test_first_name(signup):
    the_firstname_field = FirstName(signup.driver)
    the_firstname_field.input_first_name(Config.FIRSTNAME)

# test the lastname
def test_last_name(signup):
    the_lastname_field = LastName(signup.driver)
...
def test_submit_signup_button(signup):
    the_submit_button = SubmitButton(signup.driver)
